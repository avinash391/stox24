...
constructor(private router: Router,private services:ApiDataService,private route:ActivatedRoute ,private toastrService: ToastrService,private globalService:GlobalService,private formBuilder: FormBuilder,public shareService:SharedDataService){}
...
onSendOTP() {
  let obj={
   Value : this.resetWithEmail?this.forgotForm.get('email').value: this.forgotForm.get('mobile').value,
   Type : this.resetWithEmail ? 1 : 2,
   Key: ''
  }
  this.services.GENERATE_USER_RESET(obj).subscribe((data:any)=>{
