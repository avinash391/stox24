...
export class LoginComponent {
  ...
  constructor(
    ...
    public shareService: SharedDataService
  ) {
  ...
  ngOnInit(): void {
    this.loginForm = this.formBuilder.group({
      userName: [
        '',
        [Validators.required, Validators.maxLength(50), Validators.min(2)],
      ],
      password: [
        '',
        [Validators.required, Validators.maxLength(50), Validators.min(2)],
  ...
  submit() {
    ...
    // console.log('isFirstTimeLoginisFirstTimeLogin ' ,isFirstTimeLogin)
    let obj = {
...
// code by pro
    this.services.LOGIN_USER(obj).subscribe(
      (data: any) => {
        this.shareService.loader(true);
        console.log("datadatadatadatadata1234" ,data);
    ...
    this.services.USER_LOGIN(formData).subscribe((data: any) => {
      ...
      this.shareService.loader(true);
      console.log('datadatadatadatadatadata1111' ,data) 
