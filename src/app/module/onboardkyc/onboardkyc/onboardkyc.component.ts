...
export class OnboardkycComponent implements OnInit {
  ...
  constructor(private services:ApiDataService,private service: GlobalService, private serviceslogin:LoginService, private sharedData: SharedDataService, private globalService:GlobalService,private formBuilder: FormBuilder,  private router:Router) {
